...
const inputNameModel = ref("双方向バインディング");


const inputNameBind = ref("a");
const inputNameOn = ref("b");
...
const inputName2Way = ref("2wayバインディング");
